...
public class CustomersController implements CustomersApi {
    ...
    @Override
    public ResponseEntity<Void> customersPost(@RequestBody OpenAPICustomer openAPICustomer) {
    ...
    @Override
    public ResponseEntity<Void> customersIdPut(@PathVariable Long id, @RequestBody OpenAPICustomer openAPICustomer) {
    ...
    private Customer convertToDomainModel(OpenAPICustomer openAPICustomer) {
        return new Customer(
